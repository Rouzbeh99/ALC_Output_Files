...
@__const.main.a = private unnamed_addr constant [32 x i32] [i32 1, i32 -1, i32 2, i32 -2, i32 3, i32 -3, i32 4, i32 -4, i32 1, i32 -1, i32 2, i32 -2, i32 3, i32 -3, i32 4, i32 -4, i32 1, i32 -1, i32 2, i32 -2, i32 3, i32 -3, i32 4, i32 -4, i32 1, i32 -1, i32 2, i32 -2, i32 3, i32 -3, i32 4, i32 -4], align 4
@__const.main.b = private unnamed_addr constant [32 x i32] [i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2], align 4
...
entry:
  %c = alloca [32 x i32], align 4
  call void @llvm.dbg.value(metadata i32 32, metadata !50, metadata !DIExpression()), !dbg !59
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %c) #11, !dbg !62
  call void @llvm.dbg.declare(metadata ptr %c, metadata !56, metadata !DIExpression()), !dbg !63
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(128) %c, i8 0, i64 128, i1 false), !dbg !63
  ...
  call void @llvm.dbg.value(metadata i32 32, metadata !24, metadata !DIExpression()), !dbg !72
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 32, !dbg !92
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %c) #11, !dbg !97
  ret i32 0, !dbg !98

for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.body.preheader ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv, metadata !57, metadata !DIExpression()), !dbg !99
  %arrayidx = getelementptr inbounds [32 x i32], ptr %c, i64 0, i64 %indvars.iv, !dbg !100
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32, !dbg !105
...
!1 = !DIFile(filename: "test.c", directory: "/home/rouzbeh/Graduate/LLVM/Active-Lane-Conslidation/Transformation Pass/Vectorizer Pass/test", checksumkind: CSK_MD5, checksum: "3cae8a7869ef7e92219212ef9dca16df")
...
!52 = !DICompositeType(tag: DW_TAG_array_type, baseType: !19, size: 1024, elements: !53)
!53 = !{!54}
